...
" highlight CursorLine ctermfg=lightgrey ctermbg=darkred cterm=bold gui=bold guifg=lightgrey guibg=darkred
highlight CursorLine gui=underline,bold cterm=underline,bold
